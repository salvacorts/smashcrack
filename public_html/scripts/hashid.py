            ...
            <div id="search" class="container">
                ...
                <div id="input" class="container">
                    <form method="get" action="/scripts/hashid.py">
                        ...
                        <input id="btn" class="button" type="submit" value="Identify!" onclick="$('#loading').show();$('#preset-dine img').hide()">
                    </form>
                </div>
                <p></p>
                <div id="input" class="container">
...
def whichisit():
    ...
    if len(jerar)==0:
        ...
        <div id=pass-Matched>
            <div id='matched'>
                <h2>Posible Encryptions:</h2>
                    <div id='password' style="color: #40d47e;">"""+algorithms[jerar[0]]+"""</div>
                    <div id='password' style="color: #40d47e;">"""+algorithms[jerar[1]]+"""</div>
                    <div id='password' style="color: #40d47e;">"""+algorithms[jerar[3]]+"""</div>"""+donateForm+"""
            </div>
        </div>
        <div id="arrow-index">
                <a href="#contact">
